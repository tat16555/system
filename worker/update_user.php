  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">แก้ไขข้อมูล</h1><a href="user.php"><button type="button" class="btn btn-warning">ดูข้อมูลผู้ใช้งานทั้งหมด</button></a>
          </div><!-- /.col -->
          <?php
        ...
        <form action="system_update_user.php" method="post" class="register-form" id="register-form">
