<?php 
    ...
    if (isset($_POST['signup'])) {
        ...
        if (empty($firstname)) {
            ...
            header("location: worker_information.php");
            ...
            try {
                ...
                $check_email = $conn->prepare("SELECT email FROM worker WHERE email = :email");
                ...
                if ($row['email'] == $email) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO worker(firstname, lastname, username, address, phone, email, password, urole) 
