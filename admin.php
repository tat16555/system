        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="admin/reserve.php" class="nav-link active">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="admin/worker.php" class="nav-link">
                  <i class="nav-icon fas fa-edit"></i>
                  <p>worker</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="admin/control.php" class="nav-link">
              ...
              <li class="nav-item">
              <li class="nav-item">
                <a href="admin/course_information.php" class="nav-link">
                  <i class="nav-icon far fa-plus-square"></i>
                  <p>เพิ่มข้อมูลคอร์สเรียน</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="admin/teacher_information.php" class="nav-link">
                  <i class="nav-icon far fa-plus-square"></i>
                  <p>เพิ่มข้อมูลครู</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="admin/bank.php" class="nav-link">
                  <i class="nav-icon far fa-plus-square"></i>
                  <p>เพิ่มข้อมูลbank</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="admin/View_gallery.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="admin/Book_Course.php" class="nav-link">
              <i class="nav-icon fas fa-file"></i>
              <p>Book Course</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="admin/code.php" class="nav-link">
              <i class="nav-icon fas fa-file"></i>
              <p>View Code php</p>
            </a>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- /.row -->
        <!-- Main row -->
        <?php require_once("admin/chrat/U_chrat.php"); ?>
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                  <p style="color:green">Verified <?php echo $verified2_percentage_formatted; ?>%</p>
                  <p style="color:red"> Not Verified <?php echo $not_verified2_percentage_formatted; ?>%</p>
