  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">แก้ไขข้อมูล</h1><a href="worker.php"><button type="button" class="btn btn-warning">ดูข้อมูลผู้ใช้งานทั้งหมด</button></a>
          </div><!-- /.col -->
          <?php
        ...
        <form action="system_update_worker.php" method="post" class="register-form" id="register-form">
                    ...
                    <h3>กรอกแบบฟอร์ม</h3>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" id="name" aria-describedby="username"value="<?=$row->username?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="phone" class="form-control" name="phone" id="phone" aria-describedby="phone" value="<?=$row->phone?>">
                        </div>
                        <div class="form-group">
